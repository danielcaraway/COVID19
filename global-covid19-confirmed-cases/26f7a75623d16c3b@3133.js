...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([["covid_wk2_grouped_confirmed.csv",new URL("./files/d213571e760f0763c85ac12c4a3aa95fcb8dac3a621870beefa28d8e4893955871691998a87442a2ccea576783a031657bba4cd7408eeb1faa1010a9baa59e44",import.meta.url)]]);
  main.builtin("FileAttachment", runtime.fileAttachments(name => fileAttachments.get(name)));
  main.variable(observer()).define(["md"], function(md){return(
md`# GLOBAL COVID19: Confirmed Cases 
## (via kaggle)  `
)});
  main.variable(observer("data")).define("data", ["d3","FileAttachment"], async function(d3,FileAttachment){return(
d3.csvParse(await FileAttachment("covid_wk2_grouped_confirmed.csv").text(), d3.autoType)
)});
...
md`## COVID19 Cases by Country (by month & day)`
)});
...
Using d3-array@2 for its lovely new [d3.group](/@d3/d3-group) method.`
)});
